...
class DirectMessages extends Component {
  ...
  componentDidMount() {
    if (this.props.messages === null)
      this.props.fetchDirectMessages(this.props.match.params.channelId);
    this.setState({ currentChannelId: this.props.match.params.channelId });
  }
  ...
  handleSubmit = e => {
    ...
    this.props.sendDirectMessage(message, this.props.match.params.channelId);

    e.target.message.value = "";
  };

  handleDeleteMessage = () => {
    this.props.deleteDirectMessage(this.state.messageToDelete);
  ...
  render() {
    if (!this.props.directMessages || !this.props.users || !this.props.users)
      return <div />;

    const { messages } = this.props.directMessages;
...
export default connect(
  mapStateToProps,
  { fetchDirectMessages, sendDirectMessage, deleteDirectMessage }
)(DirectMessages);
